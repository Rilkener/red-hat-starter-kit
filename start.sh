...
check_yes_no 'curl -s https://raw.githubusercontent.com/REPLACE/mypost/master/.pylintrc -o ~/.pylintrc'
check_yes_no 'curl -fLo ~/.config/nvim/init.vim --create-dirs https://raw.githubusercontent.com/REPLACE/mypost/master/init.vim'
...
if [ "$CONT" = "y" ]; then
    ...
    check_yes_no 'curl -s https://raw.githubusercontent.com/REPLACE/mypost/master/.eslintrc.js -o ~/.eslintrc.js'
fi
